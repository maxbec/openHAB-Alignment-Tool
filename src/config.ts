...
export const viewsCommonConfigKeys: (keyof ViewsCommonConfig)[] = ["defaultItemLimit", "formats", "pageItemLimit", "showRelativeDateMarkers"];
...
export const viewsConfigKeys: ViewsConfigKeys[] = ["commits", "repositories", "fileHistory", "lineHistory", "branches", "remotes", "stashes", "tags", "contributors", "searchAndCompare"];
